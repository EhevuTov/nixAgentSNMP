...
{
    printf
        ("usage: linkTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
    ...
    while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
        ...
        case 'H':
            ...
            init_agent("linkTable");    /* register our .conf handlers */
            init_linkTable();
            init_snmp("linkTable");
     ...
     */
    init_agent("linkTable");

    /*
     * init linkTable mib code 
     */
    init_linkTable();

    /*
     * read linkTable.conf files. 
     */
    init_snmp("linkTable");
